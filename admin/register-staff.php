<?php
    ...
    $query="INSERT into staffRegistration(regNo,firstName,middleName,lastName,gender,contactNo,email,password) values(?,?,?,?,?,?,?,?)";
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    ...
                    <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Staff Registration Form</h4>
